                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pagamento_usuario" id="pagamento_usuario" class="form-control" placeholder="Conta de e-mail cadastrada no PagSeguro"
                                           value="<?= $data['pagamento']->pagamento_usuario ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pagamento_senha" id="pagamento_senha" class="form-control" placeholder="Chave API fornecida pelo PagSeguro"
                                           value="<?= $data['pagamento']->pagamento_senha ?>" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="pagamento_retorno">URL Notificação Pagseguro </label>
                                    <input  disabled type="text" name="pagamento_retorno" id="pagamento_retorno" class="form-control"
                                           value="<?= Http::base()?>/notificacao/pagseguro/" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
